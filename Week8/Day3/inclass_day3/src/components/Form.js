    ...
    return (
        <>
            ...
            <form className="inputForm">
                ...
                <br />
                <input onChange={props.handleChange} name="age" placeholder="Age" value={props.age} />
                <br />
                <br />
                <label>
                    <input type="radio" name="gender" value="male" checked={props.gender === "male"} onChange={props.handleChange} />
                    Male
                </label>
                <label>
                    <br />
                    <input type="radio" name="gender" value="female" checked={props.gender === "female"} onChange={props.handleChange} />
                    Female
                </label>
                <br />
                <label>Select your destination</label>
                <br />
                <select onChange={props.handleChange} name="destination" value={props.destination}>
                ...
                <div>
                    ...
                    <span>Nuts free</span>
                    <br />
                    <input type="checkbox" name="lactoseFree" onChange={props.handleChange} checked={props.lactoseFree} />
